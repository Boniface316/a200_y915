...
class image_converter:
    ...
    def callback2(self, data):
        ...
        def calculated_forward_kinematics(self,image1,image2):
...
#Control Part starts here------------------------------------------------------------------------------------------
        ...
        def control_closed(self, image1,image2):
            ...
            q = angle_trajectory(self) # estimate initial value of joints'
        ...
        fk_end_effector =calculated_forward_kinematics(self,self.image1,self.image2)
        ...
        print ("FK result", calculated_forward_kinematics(self,self.image1,self.image2))
        print("End effector position",end_effector_position(self,self.image1,self.image2))
